...
public class BBC_RSS {
    ...
    public static void main(String[] args) {
        File root = null;
        try {
            root = new File(BBC_RSS.class.getProtectionDomain().getCodeSource().getLocation().toURI()).getParentFile();
        } catch (URISyntaxException ex) {
            Logger.getLogger(BBC_RSS.class.getName()).log(Level.SEVERE, null, ex);
        }
